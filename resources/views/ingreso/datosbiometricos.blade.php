        ...
        <div style="width: 250px; height: 100%;">
            <table>
                ...
                <tr>
                    <td style="">
                        <div style="width: 118px; height:150px;">
                            <img src="{{ public_path('huellas/inscripcion/70757838.jpg')}} " alt="" width="118">
                ...
                <tr>
                    <td colspan="2" style="">
                        <div style="width: 100%; height:20px; text-align:center; background:#d9d9d977;">
                            <span>Control puerta 23-06-23</span>
                       </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2" style="">
                        <div style="width: 100%; height:20px; text-align:center; background:#d9d9d977;">
                            <span>Control puerta 24-06-23</span>
                       </div>
                    </td>
                </tr>
        ...
        <div style="width: 270; height: 850px; padding-left:20px;">
            <table>
                ...
                <tr>
                    ...
                    <td>
                       <div style="width: 155px; height:175px;">    
                            <img src="{{ public_path('fotos/inscripcion/70757838.jpg')}} " alt="" height="170">
                ...
                <tr>
                    <td colspan="2">
                       <div style="width: 100%; height:370px; text-align:center;">
                          <img src="{{ public_path('fotos/inscripcion/70757838.jpg')}} " alt="" height="360">
