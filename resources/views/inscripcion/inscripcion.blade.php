        ...
        <div style="margin-top:6px; ">
            <table style="font-size:11pt; font-weight:bold; width:100%;">
                ...
                <tr>
                    ...
                    <td align="left" valign="top"><div style="text-align: justify; font-weight: regular; margin-top: -36px;"><span style="text-transform: uppercase;"> 11 julio de 2023</span></div></td>
                </tr>
            </table>
        </div>
