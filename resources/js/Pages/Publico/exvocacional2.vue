...
<LayoutExVocacional>
    ...
    <div v-else class="flex align-center justify-center">
        <div v-if="nropregunta < 20" class="align-center justify-center mt-7" style="background: #00000008; border-radius: 8px; padding: 20px;">
            ...
            <div v-for="respuesta in alternativas" :key="respuesta.ide">
                <a-radio-group v-if="tiempo > 0" v-model:value="respuestas[index]">
            ...
            <div class="flex justify-between mt-4">
                ...
                <div>
                    <a-button style="background: navy; padding: 10px 10px; height: 40px; width: 200px; border-radius: 5px; color: white;" @click="guardar(preguntas[nropregunta].id_pregunta, respuestas[index].id)">Siguiente</a-button>
                </div>
            </div>
    ...
    <div v-if="nropregunta == 20" style="display: flex; justify-content:center;">
        ...
        <div style="width: 330px;">
            ...
            <div class="flex justify-center mt-4 mb-3"> 
                <a-button type="primary" @click="cerrarmodal()">ACEPTAR</a-button>
            </div>
...
const tiempoRestante = ref (20 * 60) // 20 minutos en segundos
