...
class Docente extends Model
{
    ...
    protected $fillable = [
        'tipo_doc', 'nro_doc', 'codigo', 'nombres', 'paterno', 'materno', 'sexo', 'fec_nac', 'condicion', 'escuela', 'estado', 'id_usuario'
    ];

    public static $rules = [
        'nro_doc' => 'required|unique:docentes',
        'codigo' => 'unique:docentes',
    ];
